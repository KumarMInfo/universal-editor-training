...
## Environments
- Preview: https://main--universal-editor-training--KumarMInfo.aem.page/
- Live: https://main--universal-editor-training--KumarMInfo.aem.live/
...
1. Open the `universal-editor-training` directory in your favorite IDE and start coding :)
